...
fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Первые",sLast:"Последние",sNext:"Вперед",sPrevious:"Назад"},sEmptyTable:"No data available in table",sInfo:"Показано _START_ до _END_ из _TOTAL_ записей",sInfoEmpty:"Показано 0 to 0 of 0 записей",sInfoFiltered:"(отфильтровано из _MAX_ total записей)",
sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Показывать по _MENU_ записей",sLoadingRecords:"Загрузка...",sProcessing:"Подождите...",sSearch:"Поиск:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Ничего не найдено"},oSearch:l.extend({},u.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};E(u.defaults);u.defaults.column={aDataSort:null,
